  ...
  const AdminLogin: React.FC = () => {
    ...
    // Image URLs from allowed domains based on CSP
    // const ILLUSTRATION_URL = "https://picsum.photos/800/600?random";
    // const LOGO_URL = "https://picsum.photos/200/200?random=2";
        ...
        >
          {/* <div className="w-full h-full flex items-center justify-center">
            <img
              ...
              className="w-full h-64 object-cover rounded-lg shadow-2xl opacity-90"
            />
          </div> */}
        </div>
        ...
        >
          <div className="w-full max-w-md">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="w-16 h-16 rounded-full border-2 border-white shadow-lg bg-gray-300 flex items-center justify-center">
                {/* <img
                  src={LOGO_URL}
                  alt="HOA Logo"
