...
const Contribution: React.FC = () => {
  return (
    <div className="bg-white min-h-screen">
      ...
      <h1 className="text-2xl text-white font-semibold p-6">Contribution</h1>
      </div>
      <div className="flex">
        {/* Main Content */}
        <main className="flex-1 bg-gray-100 p-6">
          ...
          <div className="grid grid-cols-4 gap-4 mb-6 mt-4">
            {["Total Funds", "Total Invoice", "Paid Amount", "Unpaid Amount"].map(
              (label) => (
          ...
          <div className="bg-white rounded-md shadow overflow-hidden">
            ...
            <ScrollArea className="max-h-64">
              {[...Array(20)].map((_, i) => (
                <div
                  key={i}
                  className="grid grid-cols-4 p-2 border-t text-sm text-gray-600"
                >
                  <div> - </div>
                  <div> - </div>
                  <div> - </div>
