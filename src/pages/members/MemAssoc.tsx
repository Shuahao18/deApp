          ...
          <div className="flex flex-col md:flex-row justify-between items-center px-6 py-4 border-b">
            ...
            <div className="flex flex-col md:flex-row items-center gap-3 relative mt-4 md:mt-0">
              ...
              <div className="relative">
                ...
                >
                  <span className="text-gray-700">Sort by:</span> {sortFilter}
                </Button>
                {showSortMenu && (
              ...
              {/* Search */}
              <div className="flex items-center border rounded-md px-2 py-1 bg-gray-50 max-w-xs w-full">
                ...
                <input
                  ...
                  className="outline-none text-sm ml-2 bg-transparent w-full"
                />
              </div>
            ...
            <table className="min-w-full text-sm">
              <thead className="bg-[#ECF0F1] text-[#718096] uppercase text-left">
                <tr>
                  ...
                  <th className="p-4 font-normal text-left">Name</th>
                  <th className="p-4 font-normal text-left">Address</th>
                  <th className="p-4 font-normal text-left">Email Address</th>
                  <th className="p-4 font-normal text-left">Status</th>
                  <th className="p-4 font-normal text-left">Actions</th>
                </tr>
              </thead>
              <tbody>
